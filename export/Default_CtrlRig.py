...
def create_control_rig(ch_folder, ch_name):
	...
	blueprint = factory.create_new_control_rig_asset(desired_package_path = '/Game/Characters/'+ch_folder+'/'+ch_name+'_CtrlRig')
...
create_control_rig('Tolka', 'Tolka_Face_jointBase')
